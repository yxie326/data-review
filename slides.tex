    ...
    \subsection{Theory}
        ...
        \begin{frame}{Equation for $E_{disp}^{(2)}$}
            \begin{itemize}
                ...
                \begin{eqnarray}
                    \nonumber
                    E_{\textrm{disp}}^{(2)} &= -\frac{1}{2\pi}\int_0^\infty d\omega \int d\mathbf{r}_A d\mathbf{r}'_A d\mathbf{r}_B d\mathbf{r}'_B \\ \nonumber
        ...
        \begin{frame}{Exchange-Dispersion Term}
            \begin{itemize}
                ...
                $$\tilde{E}^{(2)}_{\textrm{exch-disp,r}} = E^{(2)}_{\textrm{exch-disp,u}} \cdot \frac{E^{(2)}_{\textrm{disp,r}}}{E^{(2)}_{\textrm{disp,u}}}$$
                $$\tilde{E}^{(2)}_{\textrm{exch-disp,r}} = \alpha \cdot E^{(2)}_{\textrm{exch-disp,u}} (\alpha = 0.686361)$$
                \item The value above is fitted from $E_{\textrm{exch-disp,u}}^{(2)}$ with LHF orbitals
                \item Non-LHF orbitals have greater o-v gaps and smaller $E_{\textrm{disp,u}}^{(2)}$, needs to re-fit with non-LHF results
            \end{itemize}
        \end{frame}
        ...
        \begin{frame}{LHF vs non-LHF orbitals}
            \begin{figure}
            \centering
            \includegraphics[width=\textwidth]{S66-terms.png}
        ...
        \begin{frame}{GRAC}
            \begin{itemize}
                ...
                $$v_{xc}^{\textrm{GRAC}} = \left\{1-f[g(\boldsymbol{r})]\right\}v_{xc}^{\textrm{PBE0}} + f[g(\boldsymbol{r})] v_{xc}^{\textrm{LB94}}$$
        ...
        \begin{frame}{GRAC \& Long-Range Behavior}
            \begin{figure}
            \centering
            \includegraphics[width=\textwidth]{GRAC.png}
