...
\section{Three-Body FDDS Dispersion}
    ...
    \subsection{Background}
        ...
        \begin{frame}{3B-69 Wavefunctional Methods}
            \begin{figure}
                \centering
                \includegraphics[width=0.8\textwidth]{3B69_wfn.png}
            \end{figure}
        \end{frame}
    ...
    \subsection{Results}
        ...
        \begin{frame}{3B-69 Systems}
            \begin{figure}
                \centering
                \includegraphics[width=0.6\textwidth]{3B69_systems.png}
            \end{figure}
        \end{frame}
        ...
        \begin{frame}{3B-69 Results}
            \begin{table}
                ...
                \begin{tabular}{c c c c c c c}
                    \hline
                    System & CCSD(T) & FDDS(aDZ) & FDDS(aTZ) & MP2 & MP2.5 & SCS-MI-CCSD \\ \hline
                    \textbf{1} & 0.181 & 0.207 & 0.210 & 0.161 & 0.179 & 0.178 \\ 
                    \textbf{2} & -0.122 & -0.069 & -0.065 & -0.178 & -0.143 & -0.128 \\
                    \textbf{3} & -0.922 & -0.905 & -0.904 & -0.937 & -0.913 & -0.918 \\
                    \textbf{4} & -0.089 & -0.003 & -0.003 & -0.239 & -0.151 & -0.100 \\
                    \textbf{5} & -0.027 & 0.002 & 0.003 & -0.061 & -0.023 & -0.026 \\ \hline
                \end{tabular}
            \end{table}
        \end{frame}
