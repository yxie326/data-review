...
\section{SAPT(DFT) Implementation}
    ...
    \subsection{Theory}
        ...
        \begin{frame}{Equation for $E_{disp}^{(2)}$}
            Coupled FDDS with hybrid ALDA kernel:
            ...
            $$[\mathbf{K}_1 (\lambda d)]_{PQ} = \sum_{ar,a'r'} (P|ar) \lambda_{ar} d_{ar} [(aa'|rr')+(ar'|a'r)] (a'r'|\mathbf{Q}|Q)$$
            $$[\mathbf{K}_2 (\lambda d)]_{PQ} = \sum_{ar,a'r'} (P|ar) \lambda_{ar} d_{ar} [(aa'|rr')-(ar'|a'r)] (a'r'|\mathbf{Q}|Q)$$
            $$[\mathbf{K}_{21} (\lambda)]_{PQ} = \sum_{ar,a'r',a''r''} (P|ar) \lambda_{ar} [(aa''|rr'')-(ar''|a''r)][(a'a''|r'r'')-(a'r''|a''r')] (a'r'|\mathbf{Q}|Q)$$
            $$[\mathbf{K}'_2 (\lambda)]_{PQ} = \sum_{ar,a'r'} (P|ar) \lambda_{ar} [(aa'|rr')-(ar'|a'r)] (a'r'|Q)$$
